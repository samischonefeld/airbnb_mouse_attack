...
function airbnb1click() {
  gameBoard1.style.background =
    "no-repeat center url(/Users/samanthaschonefeld/wdi/unit01/projects/mouse-game/assets/airbnb1.jpg)";
...
function airbnb2click() {
  gameBoard1.style.background =
    "no-repeat center url(/Users/samanthaschonefeld/wdi/unit01/projects/mouse-game/assets/airbnb2.jpg)";
...
function hideMouse1() {
  setInterval(function() {
    mouse1.classList.toggle("hidden");
  }, 1000);
}
...
function hideMouse2() {
  setInterval(function() {
    mouse2.classList.toggle("hidden");
  }, 2000);
}
var mouse3 = document.getElementById("mouse3");
function hideMouse3() {
  setInterval(function() {
    mouse3.classList.toggle("hidden");
  }, 3000);
}
...
function hideMouse4() {
  setInterval(function() {
    mouse4.classList.toggle("hidden");
  }, 2500);
}
var mouse5 = document.getElementById("mouse5");
function hideMouse5() {
  setInterval(function() {
    mouse5.classList.toggle("hidden");
  }, 3500);
}
...
function hideMouse6() {
  setInterval(function() {
    mouse6.classList.toggle("hidden");
  }, 1000);
}
...
function hideMouse7() {
  setInterval(function() {
    mouse7.classList.toggle("hidden");
  }, 2000);
}
...
function hideMouse8() {
  setInterval(function() {
    mouse8.classList.toggle("hidden");
  }, 2500);
}
